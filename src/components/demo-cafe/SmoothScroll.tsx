...
/**
 * Inertial scroll for the demo, same library and easing curve as the main
 * Ktenor site. Disabled under reduced motion — hijacking the scroll is
...
export function SmoothScroll() {
  useEffect(() => {
    ...
    // Anchor nav has to go through Lenis or it fights it.
